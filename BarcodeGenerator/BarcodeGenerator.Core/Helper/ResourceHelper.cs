...
namespace BarcodeGenerator.Core.Helper
{
	public static class ResourceHelper
	{
		...
		public static void SetDarkColors(bool lightBackground)
		{
			...
			SetDynamicResource(DynamicSecondaryColor, lightBackground ? "SecondaryColor" : "SecondaryDarkColor");
			...
			SetDynamicResource(DynamicTextSecondaryColor, "TextPrimaryDarkColor");
